...
namespace CRUD_application_2.Controllers
{
    public class UserController : Controller
    {
        ...
        public ActionResult Edit(int id)
        {
            ...
            // If successful, it returns the Edit view with the user information to be edited.
            ...
            return View("Edit", user); // "Edit" is the name of the view file, and "user" is the model passed to the view
        ...
        public ActionResult Delete(int id)
        {
            ...
            return View("Delete", user); // "Delete" is the name of the view file, and "user" is the model passed to the view
